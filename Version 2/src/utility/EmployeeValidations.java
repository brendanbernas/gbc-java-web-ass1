 ...
 *Assignment: #1
 *Author: Piotr Grabowski, Elise Tang
 *Student Number: 100730728, 100626492
 *Date: Oct 19,2017
 *Description: This servlet is used a helper class to validate the client's entries into the employee entry form
 */
package utility;
